...
// RCSplit definitions
// e.g. WHO_AM_I_ADDR 0x75 // WHO_AM_I register
...
int main(void)
{
  ...
  runcam_init(&huart3); // JD: changed from 1 to 3
    ...
    */
    ...
    RunCam_Setting settings[NUM_RUNCAM_SETTINGS];
