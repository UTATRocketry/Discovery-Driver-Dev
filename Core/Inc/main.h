...
#define IV8_IN_Pin GPIO_PIN_10
#define IV8_IN_GPIO_Port GPIOE
#define IV24_IN_Pin GPIO_PIN_11
#define IV24_IN_GPIO_Port GPIOE
#define IMAIN_IN_Pin GPIO_PIN_12
#define IMAIN_IN_GPIO_Port GPIOE
